        ...
        fetch(`${API}/auth/profile`, { headers: { Authorization: `Bearer ${token}` } })
            ...
            .then(json => {
                if (json.success && json.data) {
                    ...
                    // Sync localStorage so next page load is instant
                    try {
