...
// ── RenderDropList ────────────────────────────────────────────────────────────
// Props:
//   navDropList    — array of nav groups (with optional .badge and children[].notifBadge)
//   onPdfClick     — handler for PDF links
//   onNavigate     — handler for hash-based navigation (also aliased as onItemClick)
//   onItemClick    — alias for onNavigate (used by AdminSideBar / ConsultantSideBar)
//   BadgeComponent — optional pill component: <BadgeComponent count={n} />
// ─────────────────────────────────────────────────────────────────────────────
            ...
            {navDropList.length === 0 ? (
                ...
                navDropList.map((nav) => (
                    <li className="nav-item" key={nav._id}>
                        ...
                        {/* ── Parent / Level-1 dropdown trigger ── */}
                        <a
                        ...
                        >
                            ...
                            {/* Number badge on the parent row */}
                            {BadgeComponent && typeof nav.badge === 'number' && (
                                <BadgeComponent count={nav.badge} />
                            )}

                            <i className="bi bi-chevron-down ms-auto" style={{ marginLeft: BadgeComponent && nav.badge > 0 ? '6px' : undefined }}></i>
                        </a>
