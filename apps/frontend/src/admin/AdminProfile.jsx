...
const DEPARTMENTS = ['IT Services','Patent Examination','Trademark Registry','Legal Services','Finance and Admin'];
const DEFAULT_PIC = 'https://placehold.co/140x140/1a3c6b/ffffff?text=Admin';
...
export default function AdminProfile() {
    const [data,    setData]    = useState({ fullName:'', email:'', employeeId:'', birthdate:'', department:'', role:'', address:'' });
    ...
    const handleSave = async (e) => {
        ...
        try {
            if (imgFile) {
                ...
                // Notify AdminAvatar to refresh photo immediately
                window.dispatchEvent(new CustomEvent('profile-picture-updated', {
            ...
            // Notify AdminAvatar to update the displayed name immediately
        ...
        <div className="profile-page-wrapper">
            ...
            <div className="profile-main-container">
                <div className="prof-loader">
                    <div className="prof-spinner" style={{ borderTopColor:'#1a3c6b' }}></div>
                    <p>Loading profile…</p>
                </div>
            </div>
            </div>
                ...
                <div className="profile-content">
                    <div className="profile-columns">
                        ...
                        <aside className="profile-left">
                            ...
                            <p className="prof-name">{data.fullName || 'Administrator'}</p>
                            <p className="prof-role">{data.role}</p>
                            ...
                            <div className="prof-photo-btns">
                                <button type="button" className="prof-btn prof-btn--navy"
                        ...
                        <section className="profile-right">
                            <form onSubmit={handleSave}>
                                ...
                                <div className="prof-section-label">Office Details</div>
                                <div className="form-grid">
                                ...
                                <Field label="Office Address" name="address" type="textarea" value={data.address}
