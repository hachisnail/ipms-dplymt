...
export default function Approvedum() {
    ...
    const load = useCallback(async () => {
        try {
            ...
            console.error('❌', err);
            setError('Failed to load Utility Model submissions.');
        } finally {
            setLoading(false);
        }
    }, []);
            ...
            <div className="ur-table-card">
                {submissions.length === 0 ? (
                    <div className="ur-empty">
                        ...
                        <p>No approved Utility Model submissions found.</p>
                    </div>
                ) : (
