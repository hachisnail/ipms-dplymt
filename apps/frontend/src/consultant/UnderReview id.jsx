// UnderReview_id.jsx — Industrial Design
...
export default function UnderReviewid() {
            ...
            <div className="ur-table-card">
                {submissions.length === 0 ? (
                    <div className="ur-empty">
                        ...
                        <p>No Industrial Design submissions are currently under review.</p>
                    </div>
                ) : (
                    ...
                    <table className="ur-table">
                        <thead><tr>
                            ...
                            <th><i className="bi bi-person"></i>DESIGNER</th>
                        ...
                        <tbody>
                            {submissions.map(s => {
                                return (
                                    <tr key={s.id}>
                                        <td><span className="ur-ref-badge">ID-{s.id}</span></td>
