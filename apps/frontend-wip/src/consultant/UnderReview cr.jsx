...
const UnderReviewcr = () => {
    ...
    const fetchSubmissions = async () => {
        try {
            ...
            const response = await axios.get(`${API_BASE_URL}/cr-submissions-under-review`);
    ...
    const handleChecklistUpdate = async (projectId, checklistData) => {
        try {
            const response = await axios.put(`${API_BASE_URL}/cr-checklist-update/${projectId}`, checklistData);
    ...
    const handleFinalAction = async (projectId, action, rejection_reason) => {
        ...
        try {
            ...
            await axios.put(`${API_BASE_URL}/cr-review-action/${projectId}`, { action, rejection_reason });
